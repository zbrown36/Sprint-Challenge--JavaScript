...
const tyrannosaurus = new Dinosaur({name:'tyrannosaurus', diet:"carnivorous", weight:"7,000 kg", length:'12m', period:'Late Cretaceous' })
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = new Dinosaur({name:'stegosaurus',diet:'herbivorous',wight:'2,000 kg',length:'9m',period:'Late Jurassic'})
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor = new Dinosaur({name:'velociraptor',diet:'carnivorous',wight:'15  kg',length:'1.8m',period:'Late Cretaceous'})
...
*/
function habitatNames(zooAnimals){
const displayNames = [];
...
*/
function lowPopulationAnimals (zooAnimals, popCount){
  return zooAnimals.filter(animal => animal.population <= popCount);
}
console.log(lowPopulationAnimals(zooAnimals, 5));
